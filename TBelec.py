...
import TBgeom
#
# Function to initialise the global variables. It computes the total number of electrons
# in the system, and allocates space for the occupancies
def init(JobDef):
    global NElectrons
...
#
# A function to evaluate the Fermi function
def Fermi(e, mu, kT):
    x = (e-mu)/kT
    ...
    return f
#
# Populate the eigenstates using the Fermi function. This function uses binary section.
